...
Depending on the CONFIG page, it is a **Model 33 ASR teletype** or one of the
...
- Reader switch. The four-position switch on the TAPE READER cabinet governs reading: START — runs the reader continuously, sending the tape to the machine at the console speed (authentic ~10 chars/sec or the fast CONFIG pace);
