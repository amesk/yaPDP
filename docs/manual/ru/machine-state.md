...
Кнопка STATE повторяет логику [REBOOT](#controls) и доступна на страницах **Panel**, **Console** (телетайп, VT52 или VT100) и **TTY**. Состояния хранятся в IndexedDB браузера и переживают перезагрузки и сессии.
