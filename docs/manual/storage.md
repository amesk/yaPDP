...
persistent disk changes.{.shot-caption}
...
drop zone and the punch-tape export.{.shot-caption}

**Paper Tapes tab:**

- Paper tape reader file. A selector for the reader (`#ptr`) holding the tapes this build ships — BASIC-11 V007A, ODT-11X-V004A, ED-11-V004B, [Lunar Lander](#vt11) and the bootstrap loader — plus any.ptap you dropped. Load one and boot it with `BOOT PR`.
...
punches a matching row of holes on the [ASR paper tape](#console).
