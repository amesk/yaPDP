...
- **Product-name spelling**: the browser version constant is now
  `window.yaPDP_VERSION` (was `YAPDP_VERSION`) — generated by
  `tools/sync-version.js`, used by the sidebar marker and the Info-page
  About block. No visible `YAPDP` remains in the codebase.
