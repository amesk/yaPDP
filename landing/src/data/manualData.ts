...
export const FLOATING_CONTROLS_DATA: FloatingControlEntry[] = [
  ...
  {
    image: '',
    nameEn: '{.disk .control-cell} ![Reboot](assets/images/manual/btn-reboot.png){.control-btn} Reboot{.control-name}', nameRu: '{.disk .control-cell} ![Кнопка перезагрузки](assets/images/manual/btn-reboot.png){.control-btn} Перезагрузка{.control-name}',
  ...
  {
    image: '',
    nameEn: '{.disk .control-cell} ![Fullscreen](assets/images/manual/btn-fullscreen.png){.control-btn} Fullscreen{.control-name}', nameRu: '{.disk .control-cell} ![Кнопка Fullscreen](assets/images/manual/btn-fullscreen.png){.control-btn} Полноэкранный режим{.control-name}',
  ...
  {
    image: '',
    nameEn: '{.disk .control-cell} ![Terminal zoom](assets/images/manual/btn-zoom.png){.control-btn} Terminal zoom{.control-name}', nameRu: '{.disk .control-cell} ![Кнопка зума](assets/images/manual/btn-zoom.png){.control-btn} Масштаб терминала{.control-name}',
