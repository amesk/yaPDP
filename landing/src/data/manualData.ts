...
export const GUEST_OS_TABLE: GuestOsEntry[] = [
  ...
  },
  {
    ...
    instructionsEn: 'login 11,70 / password PDP',
    instructionsRu: 'логин 11,70 / пароль PDP',
  ...
  },
  {
    ...
    instructionsEn: 'login 1,2 / password SYSTEM',
    instructionsRu: 'логин 1,2 / пароль SYSTEM',
    credentials: '1,2 (SYSTEM)',
  },
  {
    disk: 'RL2',
    name: 'RSTS/E v7.0',
  ...
  },
  {
    ...
    instructionsEn: 'CTRL/D → login root',
    instructionsRu: 'CTRL/D → логин root',
    credentials: 'root',
  },
  {
    disk: 'RP1',
  ...
  },
  {
    ...
    instructionsEn: 'answer prompts, login 11,70',
    instructionsRu: 'ответьте на подсказки, логин 11,70',
    credentials: '11,70',
  },
  {
    disk: 'RP3',
    ...
    instructionsEn: 'auto-logs 1,2 SYSTEM',
    instructionsRu: 'автоматический вход 1,2 SYSTEM',
    credentials: '1,2 (SYSTEM)',
  },
  {
    disk: 'RP4',
