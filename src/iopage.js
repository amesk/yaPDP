...
function dl11(vt52Unit, deviceVector) {
    ...
    // Proactively initialize console UI for tty0 so keyboard input works immediately
    if (unit === 0) {
        setTimeout(function() { ensureTtyUI(0); }, 0);
    }
...
// ================================================================
// MOVED to src/diskstore.js (refactor): DiskStore is not a device — it
// is the write-back layer shared by every machine stack. pdp11.html
// loads src/diskstore.js BEFORE this file, so `var DiskStore` here is
// the shared instance from that module. The full implementation and
// design notes live there.
// ================================================================
